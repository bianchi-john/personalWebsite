...
function prendiStrutture(citta) {//Eseguo una chiamata ajax dove indico il parametro "luogo" grazie all'argomento della funzione
  $.getJSON('api/getStrutture.php?luogo=' + citta, function (data)//a seconda del luogo selezioanto decido la tipologia di icone per i marker
  {
    ...
    for (var i in data) {//ciclo che scorre tutti gli elementi della chiamata ajax, ovvero tutte le informazioni relative alle strutture di una determinata citta'
